...
<div>
  <div style={{ display: 'inline-block', marginRight: '10px' }}>
    <img src={require("./pictures/al1.png").default} alt="al1" width="400" />
  </div>
  <div style={{ display: 'inline-block', marginRight: '10px' }}>
    <img src={require("./pictures/hfo2.png").default} alt="hfo2" width="400" />
  </div>
  <div style={{ display: 'inline-block' }}>
    <img src={require("./pictures/MgAlCu.png").default} alt="MgAlCu" width="400" />
  </div>
  <div style={{ display: 'inline-block' }}>
  <img src={require("./pictures/LiGePS.png").default} alt="LiGePS" width="400" />
  </div>
</div>
...
<div>
  <div style={{ display: 'inline-block', marginRight: '10px' }}>
    <img src={require("./pictures/optim_e.png").default} alt="optim_e" width="400" />
  </div>
  <div style={{ display: 'inline-block', marginRight: '10px' }}>
    <img src={require("./pictures/optim_f.png").default} alt="hfo2" width="400" />
  </div>
</div>

NEP 模型在 LKF、 ADAM 和 SNES(GPUMD 训练)下的loss 收敛情况。