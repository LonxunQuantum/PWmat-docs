...
- 以 GaAs/AlAs 为例（**晶格常数相近**）：
  ...
  1. 从数据库分别导入 GaAs 和 AlAs 体材料结构：在菜单栏中依次点击`文件`→`从数据库导入`→`选择对应元素并搜素`→`选择晶胞并载入`;
  2. 结构组合：在菜单栏中依次点击`建模`→`构建异质结构`→`依次添加结构`→`异质结方向选c`（垂直搭建）→ 详细设置中选择新的晶格常数。

<table><tr>
    <td> 
        <center>
            <img src={require('./nested/31.png').default} alt="Drawing" />
            <font>构建异质结</font>
        </center>
    </td>
    <td> 
        <center>
            <img src={require('./nested/32.png').default} alt="Drawing" />
            <font>参数设置</font>
        </center>
    </td>
</tr></table>
...
- 以 Fe/TiC 共格界面为例（**晶格常数相差大**）：
  ...
  1. 从数据库分别导入 Fe 和 TiC 体材料结构：在菜单栏中依次点击`文件`→`从数据库导入`→`选择对应元素并搜素`→`选择晶胞并载入`;
...
<table><tr>
    <td> 
        <center>
            <img src={require('./nested/33.png').default} alt="Drawing" />
            <font>构建异质结</font>
        </center>
    </td>
    <td> 
        <center>
            <img src={require('./nested/34.png').default} alt="Drawing" />
            <font>参数设置</font>
        </center>
    </td>
</tr></table>
...
- 以 MoS<sub>2</sub>/石墨烯层间二维异质结为例（**晶格常数相差大**）：
  ...
  1. 分别导入单层石墨烯和 MoS<sub>2</sub> 结构：可以从数据库中导入，并进行[二维材料建模](#33-二维材料)，在菜单栏中依次点击`文件`→`从数据库导入`→`选择对应元素并搜素`→`选择晶胞并载入`;
...
<table><tr>
    <td> 
        <center>
            <img src={require('./nested/35.png').default} alt="Drawing" />
            <font>构建异质结</font>
        </center>
    </td>
    <td> 
        <center>
            <img src={require('./nested/36.png').default} alt="Drawing" />
            <font>参数设置</font>
        </center>
    </td>
</tr></table>
...
:::tip NOTE:
镜像：打开后拼接前结构会先沿着输运方向进行镜像操作
 
复制边界原子：拼接时复制结构输运方向边界上的原子
:::
