...
You can also specify the desired [physical properties](../../Parameter%20details#type_physical_property) in the **model parameter** of the JSON file.
