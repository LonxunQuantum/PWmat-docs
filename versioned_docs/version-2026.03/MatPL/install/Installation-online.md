...
MatPL-2026.3 lammps 接口源码位于 MatPL 源码目录 `MatPL-2026.3/lmps/lammps-2026.3` 下。您也可以通过 [github 下载](https://github.com/LonxunQuantum/lammps-MatPL) 下载源码，或下载 release 包。
